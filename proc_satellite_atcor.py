...
proc_atcor.defaults['refs_stp'] = [0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.02]
proc_atcor.defaults['nrefs_stp'] = [0.05,0.05,0.05,0.05,0.05,0.08,0.08,0.08,0.1,0.1]
proc_atcor.defaults['inds_stp'] = [0.05,0.05,0.005,0.05]
