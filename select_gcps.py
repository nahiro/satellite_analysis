...
parser.add_argument('--xthr',default=XTHR,type='float',help='Max difference in X (%default)')
parser.add_argument('--ythr',default=YTHR,type='float',help='Max difference in Y (%default)')
parser.add_argument('-s','--trg_indx_step',default=TRG_INDX_STEP,type='int',help='Target step x index (%default)')
parser.add_argument('-S','--trg_indy_step',default=TRG_INDY_STEP,type='int',help='Target step y index (%default)')
parser.add_argument('--smooth_x',default=SMOOTH,type='float',help='Smoothing factor for X from 0 to 1 (%default)')
parser.add_argument('--smooth_y',default=None,type='float',help='Smoothing factor for Y from 0 to 1 (%default)')
parser.add_argument('-r','--replace',default=False,action='store_true',help='Replace mode (%default)')
parser.add_argument('-e','--exp',default=False,action='store_true',help='Output in exp format (%default)')
parser.add_argument('-v','--verbose',default=False,action='store_true',help='Verbose mode (%default)')
parser.add_argument('-d','--debug',default=False,action='store_true',help='Debug mode (%default)')
