...
proc_download.pnams.append('indices_path')
...
proc_download.params['indices_path'] = 'Sentinel-2 indices on NAS'
...
proc_download.param_types['indices_path'] = 'string'
...
proc_download.defaults['indices_path'] = '/SATREPS/ipb/User/1_Spatial-information/Sentinel-2/Cihea/indices'
...
proc_download.defaults['dflag'] = [True,True,True,True,True,True,True,True]
proc_download.defaults['oflag'] = [False,False,False,False,False,False,False,False]
proc_download.list_sizes['dflag'] = 8
proc_download.list_sizes['oflag'] = 8
proc_download.list_labels['dflag'] = ['planting','L2A','geocor','indices','parcel','atcor','interp','tentative_interp']
...
proc_download.input_types['indices_path'] = 'box'
