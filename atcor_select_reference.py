...
ndvi = (b8.astype(np.float64)-b4.astype(np.float64))/(b8.astype(np.float64)+b4.astype(np.float64))
nv = ndvi.copy()
scl = np.load('scl.npy')
#cnd = (scl < 3.9) | (scl > 7.1)
...
b8[cnd] = np.nan
nv[cnd] = np.nan
b2_mean = np.nanmean(b2.astype(np.float64),axis=0)
b3_mean = np.nanmean(b3.astype(np.float64),axis=0)
b4_mean = np.nanmean(b4.astype(np.float64),axis=0)
b8_mean = np.nanmean(b8.astype(np.float64),axis=0)
nv_mean = np.nanmean(nv,axis=0)
...
nv_std = np.nanstd(nv,axis=0)

np.save('ndvi.npy',ndvi.astype(np.float32))
np.save('b2.npy',b2)
np.save('b3.npy',b3)
np.save('b4.npy',b4)
np.save('b8.npy',b8)
np.save('nv.npy',nv.astype(np.float32))
np.save('b2_mean.npy',b2_mean.astype(np.float32))
np.save('b3_mean.npy',b3_mean.astype(np.float32))
np.save('b4_mean.npy',b4_mean.astype(np.float32))
np.save('b8_mean.npy',b8_mean.astype(np.float32))
np.save('nv_mean.npy',nv_mean.astype(np.float32))
np.save('b2_std.npy',b2_std.astype(np.float32))
np.save('b3_std.npy',b3_std.astype(np.float32))
np.save('b4_std.npy',b4_std.astype(np.float32))
np.save('b8_std.npy',b8_std.astype(np.float32))
np.save('nv_std.npy',nv_std.astype(np.float32))


b2_std = np.load('../b2_std.npy')
b3_std = np.load('../b3_std.npy')
b4_std = np.load('../b4_std.npy')
b8_std = np.load('../b8_std.npy')
