...
proc_phenology.pnams.append('trans_source')
...
proc_phenology.params['buffer_paddy'] = 'Buffer for Paddy Mask (m)'
proc_phenology.params['buffer_parcel'] = 'Buffer for Parcel Mask (m)'
...
proc_phenology.params['trans_source'] = 'Planting Data Source'
...
proc_phenology.param_types['trans_source'] = 'string_select_list'
...
proc_phenology.defaults['trans_source'] = ['final','v1.4']
...
proc_phenology.defaults['trans_thr5'] = [0.02,30.1]
proc_phenology.defaults['atc_params'] = [1.0,10.0]
...
proc_phenology.list_sizes['trans_source'] = 2
proc_phenology.list_sizes['trans_select'] = 4
...
proc_phenology.list_labels['trans_source'] = [('Product :',['final','preliminary','planting','test']),(' Version :',['v1.4','v1.3','v1.2','v1.1','v1.0',''])]
proc_phenology.list_labels['trans_select'] = ['Around Probable Planting','Probable Planting Indicator','Around Probable Planting (Bojongsoang)','Probable Planting Indicator (Bojongsoang)']
...
proc_phenology.input_types['trans_source'] = 'string_select_list'
...
proc_phenology.expected['trans_fnam'] = '*.csv'
proc_phenology.expected['head_fnam'] = '*.csv'
proc_phenology.expected['harvest_fnam'] = '*.csv'
proc_phenology.expected['assess_fnam'] = '*.csv'
for pnam in proc_phenology.pnams:
    proc_phenology.values[pnam] = proc_phenology.defaults[pnam]
proc_phenology.select_types['trans_source'] = ['rw','rw']
