...
proc_phenology.param_types['trans_source'] = 'string_list'
...
proc_phenology.list_labels['trans_source'] = ['Product :',' Version :']
...
proc_phenology.input_types['trans_source'] = 'string_list'
