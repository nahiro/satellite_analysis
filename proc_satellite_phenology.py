...
proc_phenology.params['assess_dthrs'] = 'Date interval for Assessment'
...
proc_phenology.defaults['assess_dthrs'] = [10,10]
...
proc_phenology.list_sizes['assess_dthrs'] = 2
...
proc_phenology.list_labels['assess_dthrs'] = ['Heading - Peak (Max) :',' Peak - Harvesting (Min) :']
