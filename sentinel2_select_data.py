...
parser.add_argument('-z','--ax1_zmin',default=None,action='append',help='Axis1 Z min for debug (%(default)s)')
parser.add_argument('-Z','--ax1_zmax',default=None,action='append',help='Axis1 Z max for debug (%(default)s)')
parser.add_argument('-s','--ax1_zstp',default=None,action='append',help='Axis1 Z stp for debug (%(default)s)')
