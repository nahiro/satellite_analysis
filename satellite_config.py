...
'download.dflag4'                     : True,
'download.dflag5'                     : True,
...
#----------- interp -----------
'interp.refs_cflag'                   : [True,False,False],
'interp.nrefs_cflag'                  : [True,False,False],
'interp.inds_cflag'                   : [True,False,False],
'interp.cflag_ref'                    : 'b',
...
'estimate.intens_fnam'                : os.path.join(main_s2_analysis,'Current','formula','intensity_formula_age_90_110.csv'),
'estimate.intens_number'              : 1,
