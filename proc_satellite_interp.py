...
proc_interp.list_labels['refs_cflag'] = ['SC Flag','Reflectance','Index']
proc_interp.list_labels['nrefs_cflag'] = ['SC Flag','Reflectance','Index']
proc_interp.list_labels['inds_cflag'] = ['SC Flag','Reflectance','Index']
