...
proc_download.defaults['dflag'] = [True,True,True]
proc_download.list_sizes['dflag'] = 3
#proc_download.list_labels['calib_params'] = ['b','g','r','e','n','Nb','Ng','Nr','Ne','Nn','NDVI','GNDVI','RGI','NRGI']
proc_download.list_labels['dflag'] = ['Sentinel-2 L2A  ','Geometrically Corrected S2  ','Planting']
