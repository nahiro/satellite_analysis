...
proc_extract.pnams.append('buffer')
...
proc_extract.params['buffer'] = 'Buffer Radius (m)'
...
proc_extract.param_types['buffer'] = 'float'
proc_extract.param_range['i_sheet'] = (1,100)
proc_extract.param_range['epsg'] = (1,100000)
proc_extract.param_range['buffer'] = (0.0,10.0e3)
...
proc_extract.defaults['buffer'] = 1.0
...
proc_extract.input_types['buffer'] = 'box'
