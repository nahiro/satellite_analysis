...
proc_interp.defaults['out_refs'] = [True,True,True,True,True,True,True,True]
proc_interp.defaults['calib_refs'] = [False,False,False,False,False,False,False,False]
proc_interp.defaults['out_nrefs'] = [True,True,True,True,True,True,True,True]
proc_interp.defaults['calib_nrefs'] = [False,False,False,False,False,False,False,False]
...
proc_interp.list_sizes['out_refs'] = 8
proc_interp.list_sizes['calib_refs'] = 8
proc_interp.list_sizes['out_nrefs'] = 8
proc_interp.list_sizes['calib_nrefs'] = 8
...
proc_interp.list_labels['out_refs'] = ['b','g','r','e1','e2','e3','n1','n2']
proc_interp.list_labels['calib_refs'] = ['b','g','r','e1','e2','e3','n1','n2']
proc_interp.list_labels['out_nrefs'] = ['Nb','Ng','Nr','Ne1','Ne2','Ne3','Nn1','Nn2']
proc_interp.list_labels['calib_nrefs'] = ['Nb','Ng','Nr','Ne1','Ne2','Ne3','Nn1','Nn2']
